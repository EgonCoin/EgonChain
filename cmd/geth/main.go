...
import (
	...
	_ "github.com/EgonCoin/EgonChain/eth/tracers/js"
	_ "github.com/EgonCoin/EgonChain/eth/tracers/native"
...
func prepare(ctx *cli.Context) {
	...
	case !ctx.GlobalIsSet(utils.NetworkIdFlag.Name):
		log.Info("Starting Geth on EgonCoin mainnet...")
	}
	...
	if ctx.GlobalString(utils.SyncModeFlag.Name) != "light" && !ctx.GlobalIsSet(utils.CacheFlag.Name) && !ctx.GlobalIsSet(utils.NetworkIdFlag.Name) {
		...
		if !ctx.GlobalIsSet(utils.RopstenFlag.Name) &&
			...
			!ctx.GlobalIsSet(utils.TestEgonFlag.Name) &&
