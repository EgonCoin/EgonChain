...
import (
	...
	"github.com/EgonCoin/EgonChain/common/fdlimit"
	"github.com/EgonCoin/EgonChain/consensus"
	"github.com/EgonCoin/EgonChain/consensus/clique"
	...
	"github.com/EgonCoin/EgonChain/eth"
	ethcatalyst "github.com/EgonCoin/EgonChain/eth/catalyst"
	"github.com/EgonCoin/EgonChain/eth/downloader"
	"github.com/EgonCoin/EgonChain/eth/ethconfig"
	"github.com/EgonCoin/EgonChain/eth/gasprice"
	"github.com/EgonCoin/EgonChain/eth/tracers"
	"github.com/EgonCoin/EgonChain/ethdb"
	"github.com/EgonCoin/EgonChain/ethstats"
	"github.com/EgonCoin/EgonChain/graphql"
	...
	lescatalyst "github.com/EgonCoin/EgonChain/les/catalyst"
	"github.com/EgonCoin/EgonChain/log"
	"github.com/EgonCoin/EgonChain/metrics"
	"github.com/EgonCoin/EgonChain/metrics/exp"
	"github.com/EgonCoin/EgonChain/metrics/influxdb"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		Name:  "networkid",
		Usage: "Explicitly set network id (integer)(For testnets: use --ropsten, --rinkeby, --goerli, --testegon instead)",
	...
	TestEgonFlag = cli.BoolFlag{
		Name:  "testegon",
		Usage: "TestEgon network: pre-configured proof-of-authority test network",
	}
...
func MakeDataDir(ctx *cli.Context) string {
	if path := ctx.GlobalString(DataDirFlag.Name); path != "" {
		...
		if ctx.GlobalBool(TestEgonFlag.Name) {
			return filepath.Join(path, "testegon")
		}
		return path
	}
...
func setBootstrapNodes(ctx *cli.Context, cfg *p2p.Config) {
	...
	case ctx.GlobalBool(TestEgonFlag.Name):
		urls = params.TestEgonBootnodes
...
func setDataDir(ctx *cli.Context, cfg *node.Config) {
	...
	case ctx.GlobalBool(TestEgonFlag.Name) && cfg.DataDir == node.DefaultDataDir():
		cfg.DataDir = filepath.Join(node.DefaultDataDir(), "testegon")
	}
}
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ethconfig.Config) {
	...
	CheckExclusive(ctx, MainnetFlag, DeveloperFlag, RopstenFlag, RinkebyFlag, GoerliFlag, SepoliaFlag, TestEgonFlag)
	...
	case ctx.GlobalBool(TestEgonFlag.Name):
		...
		cfg.Genesis = core.DefaultTestEgonGenesisBlock()
		SetDNSDiscoveryDefaults(cfg, params.TestEgonGenesisHash)
	case ctx.GlobalBool(DeveloperFlag.Name):
		if !ctx.GlobalIsSet(NetworkIdFlag.Name) {
			cfg.NetworkId = 1337
		}
...
func MakeGenesis(ctx *cli.Context) *core.Genesis {
	...
	case ctx.GlobalBool(TestEgonFlag.Name):
		genesis = core.DefaultTestEgonGenesisBlock()
	case ctx.GlobalBool(DeveloperFlag.Name):
