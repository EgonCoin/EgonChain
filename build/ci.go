...
import (
	...
	"github.com/EgonCoin/EgonChain/crypto/signify"
	"github.com/EgonCoin/EgonChain/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/EgonCoin/EgonChain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/EgonCoin/EgonChain/mobile")
