...
var (
	...
	TestEgonGenesisHash  = common.HexToHash("0xd4c7f6d71deddf9249a95da5d1e7f1eebdb41a20f48e91b04aef5ab5ffa9b103")
)
...
var TrustedCheckpoints = map[common.Hash]*TrustedCheckpoint{
	...
	TestEgonGenesisHash:  TestEgonTrustedCheckpoint,
}
...
var CheckpointOracles = map[common.Hash]*CheckpointOracleConfig{
	...
	TestEgonGenesisHash:  TestEgonCheckpointOracle,
}

var (
	// MainnetChainConfig is the chain parameters to run a node on the main network.
	MainnetChainConfig = &ChainConfig{
		ChainID:             big.NewInt(659),
	...
	MainnetCheckpointOracle = &CheckpointOracleConfig{
		Address: common.HexToAddress("0x51944482997eB509aB8fcad001E3E8B437aC9F74"),
		Signers: []common.Address{
			common.HexToAddress("0x51944482997eB509aB8fcad001E3E8B437aC9F74"),
		},
		Threshold: 2,
	}
	...
	// TestEgonChainConfig is the chain parameters to run a node on the main network.
	TestEgonChainConfig = &ChainConfig{
		ChainID:             big.NewInt(759),
		HomesteadBlock:      big.NewInt(0),
		EIP150Block:         big.NewInt(0),
		EIP155Block:         big.NewInt(0),
		EIP158Block:         big.NewInt(0),
	...
	// TestEgonTrustedCheckpoint contains the light client trusted checkpoint for the main network.
	TestEgonTrustedCheckpoint = &TrustedCheckpoint{
		SectionIndex: 1,
	...
	TestEgonCheckpointOracle = &CheckpointOracleConfig{
		Address: common.HexToAddress("0x51944482997eB509aB8fcad001E3E8B437aC9F74"),
		Signers: []common.Address{
			common.HexToAddress("0x51944482997eB509aB8fcad001E3E8B437aC9F74"),
		},
